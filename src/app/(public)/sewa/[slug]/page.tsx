        ...
        <div className="min-h-screen bg-white pb-20 font-sans">
            <main className="container pt-3 px-4">
                ...
                <div className="text-sm text-gray-500 mb-4 flex items-center gap-2">
                    ...
                    <span>/</span>
                    <Link href="/search?status=rent" className="hover:text-primary">Disewa</Link>
                    <span>/</span>
                ...
                {/* Media Gallery */}
                <div className="grid grid-cols-4 grid-rows-2 gap-2 h-[400px] md:h-[500px] rounded-xl overflow-hidden mb-4">
                    {/* Main Image */}
                    <div className="col-span-4 md:col-span-2 row-span-2 relative bg-gray-100 group">
                        ...
                        <div className="absolute top-4 left-4 z-10">
                            <span className="px-3 py-1.5 rounded-md text-sm font-bold uppercase tracking-wide text-white shadow-sm bg-[#E0193E]">
                                Disewa
                            </span>
                        </div>
                    </div>
